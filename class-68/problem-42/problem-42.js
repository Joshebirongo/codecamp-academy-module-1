...
let continueTransactiion; // "Yes" || "no"
...
do {
  ...
  continueTransactiion = prompt("Do you want another withdrawal? (yes/no)");
} while (continueTransactiion.toLowerCase() === "yes");
