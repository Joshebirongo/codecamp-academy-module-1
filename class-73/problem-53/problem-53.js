...
// Problem: Product Inventory Analyszer

// Initial dataset
let prices = [120, 85, 60, 150, 45, 200, 95];

// 1. Print total number of products
console.log(`Total product: ${prices.length}`);
...
console.log(`\nRemoved last prices: ${removedPrice}`);
...
console.log(`Produt above $100: ${productsAbove100}`);
