...
If attendance is below 75%, the student automatically fails, regardless of grade.
...
Student grade: 82 Attendance: 90% Final project submitted: yes

Result: PASS Performance level: Good
