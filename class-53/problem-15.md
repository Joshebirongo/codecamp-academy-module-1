...
The system must determine whether a person is allowed to enter the building based on:

Their age
Whether they have an access card
Access Rules
A person must be 18 years old or older to enter the building.

If the person is 18 or older, the system must check if they have an access card.

Access is granted only if the person has an access card.
