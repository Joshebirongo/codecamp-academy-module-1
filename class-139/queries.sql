...
-------------------------------------------------------------------------------
-- Exercise 5
-- Display only title and publication year of every book.
...
-- Exercise 7
-- Dispaly all books that are currently available.
...
-------------------------------------------------------------------------------
-- Exercise 10
-- Display all authors born after 1948.
SELECT * FROM author WHERE birth_year > 1948;
-------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------
-- Exercise 13
-- Display all loans that have not been returned.
...
-------------------------------------------------------------------------------
-- Exercise 22
-- Display only the newest two published books.
...
-------------------------------------------------------------------------------
-- Exercise 27
-- Find the oldest publication_year.
...
-- Exercise 30
-- Display all authors whose name starts with letter "J".
...
-------------------------------------------------------------------------------
-- Exercise 33
-- Display all books published after 1950 that are available.
...
-------------------------------------------------------------------------------
-- Bonus 5
-- Count how many books are currenty unavailable.
